...
//*****************************************************************************
//Define for PUMPREQUEST register
//*****************************************************************************
...
void Example_CallFlashAPI(void)
{
	...
	oReturnCheck = Fapi_initializeAPI(F021_CPU0_W1_BASE_ADDRESS, 200);//for now keeping it out
	...
	// Fapi_setActiveFlashBank function sets the Flash bank1 and FMC1 for further
	// Flash operations to be performed on the bank1
	// Note that the parameter passed is Fapi_FlashBank1 since FMC0 register base address is passed to Fapi_initializeAPI()
