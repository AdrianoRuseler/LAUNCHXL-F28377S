...
F2837xS_Adc.obj: ../F2837xS_Adc.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.1.LTS/bin/cl2000" -v28 -ml -mt --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.1.LTS/include" --include_path="A:/Dropbox/GitHub/LAUNCHXL-F28377S/Base/timed_adc_soc_software_led_blink_pwm_cpu01/Header" --include_path="C:/ti/c2000/C2000Ware_1_00_04_00/device_support/f2837xs/headers/include" --include_path="C:/ti/c2000/C2000Ware_1_00_04_00/device_support/f2837xs/common/include" --define=CPU1 -g --diag_suppress=10063 --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="F2837xS_Adc.d_raw" $(GEN_OPTS__FLAG) "$<"
...
timed_adc_soc_software_led_blink_epwm_cpu01.obj: ../timed_adc_soc_software_led_blink_epwm_cpu01.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.1.LTS/bin/cl2000" -v28 -ml -mt --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.1.LTS/include" --include_path="A:/Dropbox/GitHub/LAUNCHXL-F28377S/Base/timed_adc_soc_software_led_blink_pwm_cpu01/Header" --include_path="C:/ti/c2000/C2000Ware_1_00_04_00/device_support/f2837xs/headers/include" --include_path="C:/ti/c2000/C2000Ware_1_00_04_00/device_support/f2837xs/common/include" --define=CPU1 -g --diag_suppress=10063 --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="timed_adc_soc_software_led_blink_epwm_cpu01.d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
